...
MEDIA_SOURCES: list[SourceFeed] = [
    ...
    SourceFeed(
        ...
        bucket="frontier_models",
        url=google_news_rss('site:reuters.com/technology/ "artificial intelligence" OR AI'),
        source_type="media",
        authority_score=95,
        region="global",
        language="en",
    ...
    SourceFeed(
        id="bloomberg_ai",
        name="Bloomberg Technology AI",
        bucket="frontier_models",
        url=google_news_rss('site:bloomberg.com/technology "artificial intelligence" OR AI'),
        source_type="media",
        authority_score=95,
        region="global",
        language="en",
...
def source_evidence_level(source: SourceFeed | Any | str | None) -> str:
    ...
    if any(ind in clean for ind in (
        "reuters", "bloomberg", "financial times", "ft.com",
        "wall street journal", "wsj", "the information",
